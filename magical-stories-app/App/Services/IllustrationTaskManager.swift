...
/// 
/// **DEPRECATED**: This complex background task system is being replaced by SimpleIllustrationService.
/// Use SimpleIllustrationService for new development.
/// This service will be removed in a future version.
@available(*, deprecated, message: "Use SimpleIllustrationService for on-demand illustration generation instead. This legacy task system will be removed.")
