...
struct MainTabView: View {
    ...
    var body: some View {
        ZStack(alignment: .bottom) {
            ...
            .onChange(of: appRouter.activeTab) { _, newRouterTab in
                ...
                let screenName = getScreenName(for: newRouterTab)
    ...
    private func getScreenName(for tab: TabItem) -> String {
        switch tab {
        case .home:
            return ClarityConfiguration.ScreenNames.home
        case .library:
            return ClarityConfiguration.ScreenNames.library
        case .collections:
            return ClarityConfiguration.ScreenNames.collections
        case .settings:
            return ClarityConfiguration.ScreenNames.settings
        }
    }
}
...
extension MainTabView {
    static func makePreview() -> some View {
        ...
        let illustrationService: SimpleIllustrationService
        do {
            illustrationService = try SimpleIllustrationService(apiKey: previewApiKey)
        } catch {
